...
class TestYamlConfigFormat:
    ...
    def test_dumps(self):
        ...
        obj = {'x': 1}
        assert fmt.dumps(None, obj) == yaml_lib.dump(obj, Dumper=yaml_lib.Dumper).encode()
    ...
    def test_dumps_root_key(self):
        ...
        obj = {'x': 1}
        assert fmt.dumps(None, obj) == yaml_lib.dump({'CONFIG': obj}, Dumper=yaml_lib.Dumper).encode()
